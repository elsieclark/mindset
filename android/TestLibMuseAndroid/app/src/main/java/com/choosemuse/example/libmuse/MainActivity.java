...
public class MainActivity extends Activity implements OnClickListener {
    ...
    int delay_initial = 10000; // 10 seconds
    int delay_normal = 5000; // 5 seconds
    Runnable runnable;
            ...
            public void run() {
                new Thread(new Runnable() {
                    public void run() {
                        try {
                            Log.v("CONN", "Posting");
                            URL url = new URL("http://165.227.46.196:4242/send_data/");
                            ...
                            String text = "";
                            text += String.format("%6.4f", alphaBuffer[0]) + " ";
                            text += String.format("%6.4f", alphaBuffer[1]) + " ";
                            text += String.format("%6.4f", alphaBuffer[2]) + " ";
                            text += String.format("%6.4f", alphaBuffer[3]) + " ";
                            text += String.format("%6.4f", alphaBuffer[4]) + " ";
                            text += String.format("%6.4f", alphaBuffer[5]) + " ";
                            text += String.format("%6.4f", betaBuffer[0]) + " ";
                            text += String.format("%6.4f", betaBuffer[1]) + " ";
                            text += String.format("%6.4f", betaBuffer[2]) + " ";
                            text += String.format("%6.4f", betaBuffer[3]) + " ";
                            text += String.format("%6.4f", betaBuffer[4]) + " ";
                            text += String.format("%6.4f", betaBuffer[5]) + " ";
                            text += String.format("%6.4f", deltaBuffer[0]) + " ";
                            text += String.format("%6.4f", deltaBuffer[1]) + " ";
                            text += String.format("%6.4f", deltaBuffer[2]) + " ";
                            text += String.format("%6.4f", deltaBuffer[3]) + " ";
                            text += String.format("%6.4f", deltaBuffer[4]) + " ";
                            text += String.format("%6.4f", deltaBuffer[5]) + " ";
                            text += String.format("%6.4f", gammaBuffer[0]) + " ";
                            text += String.format("%6.4f", gammaBuffer[1]) + " ";
                            text += String.format("%6.4f", gammaBuffer[2]) + " ";
                            text += String.format("%6.4f", gammaBuffer[3]) + " ";
                            text += String.format("%6.4f", gammaBuffer[4]) + " ";
                            text += String.format("%6.4f", gammaBuffer[5]) + " ";
                            text += String.format("%6.4f", thetaBuffer[0]) + " ";
                            text += String.format("%6.4f", thetaBuffer[1]) + " ";
                            text += String.format("%6.4f", thetaBuffer[2]) + " ";
                            text += String.format("%6.4f", thetaBuffer[3]) + " ";
                            text += String.format("%6.4f", thetaBuffer[4]) + " ";
                            text += String.format("%6.4f", thetaBuffer[5]) + " ";
                            Log.v("DATA", text);

                            wr.write("data=" + text);
                            wr.flush();
                            Log.v("CONN", "CONNECTED");

                            int responseCode = conn.getResponseCode();

                        }
                        catch (Exception e) {
                            Log.v("CONN", "COULD NOT CONNECT");
                        }
                ...
                h.postDelayed(runnable, delay_normal);
...
// See https://g.co/AppIndexing/AndroidStudio for more information.
    ...
    public void receiveMuseDataPacket(final MuseDataPacket p, final Muse muse) {
        ...
        switch (p.packetType()) {
            case EEG:
                break;
            case ALPHA_ABSOLUTE:
                Log.v("PACKET", "GOT AN ALPHA PACKET!");
                assert (alphaBuffer.length >= n);
                getEegChannelValues(alphaBuffer, p);
                Log.v("PACKET", Double.toString(p.getEegChannelValue(Eeg.EEG1)));
                alphaStale = true;
                break;
            case BETA_ABSOLUTE:
                Log.v("PACKET", "GOT A BETA PACKET!");
                Log.v("PACKET", Double.toString(p.getEegChannelValue(Eeg.EEG1)));
    ...
    private void updateAlpha() {
        ...
        elem1.setText(String.format("%6.6f", alphaBuffer[0]));
        TextView elem2 = (TextView) findViewById(R.id.elem2);
        elem2.setText(String.format("%6.6f", alphaBuffer[1]));
        TextView elem3 = (TextView) findViewById(R.id.elem3);
        elem3.setText(String.format("%6.6f", alphaBuffer[2]));
        TextView elem4 = (TextView) findViewById(R.id.elem4);
        elem4.setText(String.format("%6.6f", alphaBuffer[3]));
    }
